...
double Spin_Orbit(double la,double mla, double msa, double lb,double mlb, double 
msb);
...
gzFile pek;
 ...
 if(argc != 4) {printf("Input format: load STATES electrons\n"); exit(0);}

load=atoi(argv[1]);       /* load=1 read vkkpkb and diag matrix, load=0 calc. vkkpkb */
STATES=atoi(argv[2]);
electrons=atoi(argv[3]);


printf("\n\nload is %d #STATES=%d #electrons=%d\n\n",load, STATES, electrons);

if(!(un_paired = malloc(electrons * sizeof(int)))) {printf("No mem_un_paired!"); exit(0);}

if(!(states = malloc(STATES*sizeof(double)))) {printf("No mem_states!"); exit(0);}
for(index=0;index < STATES; index++)
 if(!( states[index]=malloc(electrons * sizeof(struct state)))) {printf("No mem_states!"); exit(0);}

if(!(states_tmp = malloc(STATES*sizeof(double)))) {printf("No mem_states_tmp!"); exit(0);}
for(index=0;index < STATES; index++)
 if(!( states_tmp[index]=malloc(electrons * sizeof(struct state)))) {printf("No mem_states_tmp!"); exit(0);}
...
if(load==1)
  if((pek=gzopen("matrix.gz","wb"))==NULL) {puts("Error in matrix.gz!"); exit(0);}

if(load==1)
  {if((pek_save=gzopen("vk1k2k3.gz","rb"))==NULL) {puts("Error in vk1k2k3.gz!"); exit(0);}}
else
  {if((pek_save=gzopen("vk1k2k3.gz","wb"))==NULL) {puts("Error in vk1k2k3.gz!"); exit(0);}}


 for(j=0; j<STATES; j++)
 {
  for(i=0; i<=j; i++)       /* calculate upper triangle of the matrix */
   {
   ...
   if(load==0)
    {
     ...
     save_Vkkpkb( i, j);         /* enormeously cpu intensive, so save it */
    }
   else
    { 
    ...
    RE_matrix = Matrix_element(method,i,j) + Matrix_element_SO(method,i,j)  +
    Matrix_element_gamma1(method, i, j) + Matrix_element_beta(method, i, j) +
    Matrix_element_alpha(method, i, j) + RE_Matrix_element_Hcf              +
    RE_Matrix_element_Hm + t2T2() + t3T3() + t4T4() + t6T6() + t7T7() + t8T8();
...
if((pek_param=fopen("param.inp","r"))==NULL) 
 {puts("Error in param.inp!"); exit(0);}
...
/* printf("%d %d %d %d %e %e %e %e %e %e %e %e %e\n",i,j,a,b,CI[2],CI[3],CI[4],CI[5],CI[6],CI[7],CI[8],CI[9],CI[10]);
...
if(Vkkpkb222==0.0) gzprintf(pek_save,"0 ");
 else gzprintf(pek_save,"%le ",Vkkpkb222);
if(Vkkpkb224==0.0) gzprintf(pek_save,"0 ");
 else gzprintf(pek_save,"%le ",Vkkpkb224);
if(Vkkpkb244==0.0) gzprintf(pek_save,"0 ");
 else gzprintf(pek_save,"%le ",Vkkpkb244);
if(Vkkpkb246==0.0) gzprintf(pek_save,"0 ");
 else gzprintf(pek_save,"%le ",Vkkpkb246);
if(Vkkpkb444==0.0) gzprintf(pek_save,"0 ");
 else gzprintf(pek_save,"%le ",Vkkpkb444);
if(Vkkpkb446==0.0) gzprintf(pek_save,"0 ");
 else gzprintf(pek_save,"%le ",Vkkpkb446);
if(Vkkpkb266==0.0) gzprintf(pek_save,"0 ");
 else gzprintf(pek_save,"%le ",Vkkpkb266);
if(Vkkpkb466==0.0) gzprintf(pek_save,"0 ");
 else gzprintf(pek_save,"%le ",Vkkpkb466);
if(Vkkpkb666==0.0) gzprintf(pek_save,"0\n");
 else gzprintf(pek_save,"%le\n",Vkkpkb666);
...
/* Vkkpkb222=Vkkpkb( 2.0, 2.0, 2.0, method, i, j);
Vkkpkb224=Vkkpkb( 2.0, 2.0, 4.0, method, i, j);
Vkkpkb244=Vkkpkb( 2.0, 4.0, 4.0, method, i, j);
Vkkpkb246=Vkkpkb( 2.0, 4.0, 6.0, method, i, j);
Vkkpkb444=Vkkpkb( 4.0, 4.0, 4.0, method, i, j);
Vkkpkb446=Vkkpkb( 4.0, 4.0, 6.0, method, i, j);
Vkkpkb266=Vkkpkb( 2.0, 6.0, 6.0, method, i, j);
Vkkpkb466=Vkkpkb( 4.0, 6.0, 6.0, method, i, j);
Vkkpkb666=Vkkpkb( 6.0, 6.0, 6.0, method, i, j); */
...
Vkkpkbq1q2q3(2.0, 2.0, 2.0, 0.0, 0.0, 0.0, method, i, j) );
...
Vkkpkbq1q2q3(4.0, 4.0, 4.0, 0.0, 0.0, 0.0, method, i, j));
...
Vkkpkbq1q2q3(6.0, 6.0, 6.0, 0.0, 0.0, 0.0, method, i, j));
...
return(
Vkkpkbq1q2q3(2.0, 2.0, 4.0, -2.0, -2.0, 4.0, method, i, j)     +
...
Vkkpkbq1q2q3(2.0, 2.0, 4.0, -1.0, -1.0, 2.0, method, i, j)     +
2.0*Vkkpkbq1q2q3(2.0, 2.0, 4.0, -1.0, 0.0, 1.0, method, i, j)  +
Vkkpkbq1q2q3(2.0, 2.0, 4.0, 0.0, 0.0, 0.0, method, i, j)       +
...
Vkkpkbq1q2q3(2.0, 4.0, 4.0, 2.0, -1.0, -1.0, method, i, j)        +
...
Vkkpkbq1q2q3(2.0, 4.0, 4.0, 0.0, 0.0, 0.0, method, i, j)          +
...
Vkkpkbq1q2q3(4.0, 4.0, 6.0, -3.0, -3.0, 6.0, method, i, j)        +
...
Vkkpkbq1q2q3(4.0, 4.0, 6.0, -2.0, -2.0, 4.0, method, i, j)        +
...
Vkkpkbq1q2q3(4.0, 4.0, 6.0, -1.0, -1.0, 2.0, method, i, j)        +
...
Vkkpkbq1q2q3(4.0, 4.0, 6.0, 0.0, 0.0, 0.0, method, i, j)          +
...
Vkkpkbq1q2q3(2.0, 6.0, 6.0, 2.0, -1.0, -1.0, method, i, j)       +
...
Vkkpkbq1q2q3(2.0, 6.0, 6.0, 0.0, 0.0, 0.0, method, i, j)         +
...
Vkkpkbq1q2q3(4.0, 6.0, 6.0, 4.0, -2.0, -2.0, method, i, j)       +
...
Vkkpkbq1q2q3(4.0, 6.0, 6.0, 2.0, -1.0, -1.0, method, i, j)       +
...
Vkkpkbq1q2q3(4.0, 6.0, 6.0, 0.0, 0.0, 0.0, method, i, j)         +
    ...
    for(m=l+1; m<electrons; m++)
     {
      ...
      sum = sum + General_Trees(power1, power2, power3, q1, q2, q3, states[i][k].l, states[i][k].ml,states[i][k].ms, states[i][l].l, states[i][l].ml,states[i][l].ms,states[i][m].l, states[i][m].ml,states[i][m].ms, states[i][k].l, states[i][k].ml,states[i][k].ms, states[i][l].l, states[i][l].ml,states[i][l].ms,states[i][m].l, states[i][m].ml,states[i][m].ms);
...
if(l!=un_paired[1])
 sum = sum + General_Trees(power1, power2, power3, q1, q2, q3, states[i][k].l, states[i][k].ml,states[i][k].ms, states[i][l].l, states[i][l].ml,states[i][l].ms,states[i][un_paired[1]].l, states[i][un_paired[1]].ml,states[i][un_paired[1]].ms, states[i][k].l, states[i][k].ml,states[i][k].ms, states[i][l].l, states[i][l].ml,states[i][l].ms,states_tmp[j][un_paired[1]].l, states_tmp[j][un_paired[1]].ml,states_tmp[j][un_paired[1]].ms);
...
for(k=0; k<electrons; k++)
 ...
 if((k!=un_paired[1]) && (k!=un_paired[2]))
  sum = sum + General_Trees(power1, power2, power3, q1, q2, q3, states[i][k].l, states[i][k].ml,states[i][k].ms, states[i][un_paired[1]].l, states[i][un_paired[1]].ml,states[i][un_paired[1]].ms,states[i][un_paired[2]].l, states[i][un_paired[2]].ml,states[i][un_paired[2]].ms, states[i][k].l, states[i][k].ml,states[i][k].ms, states_tmp[j][un_paired[1]].l, states_tmp[j][un_paired[1]].ml,states_tmp[j][un_paired[1]].ms,states_tmp[j][un_paired[2]].l, states_tmp[j][un_paired[2]].ml,states_tmp[j][un_paired[2]].ms);
...
return(General_Trees(power1, power2, power3, q1, q2, q3, states[i][un_paired[1]].l, states[i][un_paired[1]].ml,states[i][un_paired[1]].ms, states[i][un_paired[2]].l, states[i][un_paired[2]].ml,states[i][un_paired[2]].ms,states[i][un_paired[3]].l, states[i][un_paired[3]].ml,states[i][un_paired[3]].ms, states_tmp[j][un_paired[1]].l, states_tmp[j][un_paired[1]].ml,states_tmp[j][un_paired[1]].ms, states_tmp[j][un_paired[2]].l, states_tmp[j][un_paired[2]].ml,states_tmp[j][un_paired[2]].ms,states_tmp[j][un_paired[3]].l, states_tmp[j][un_paired[3]].ml,states_tmp[j][un_paired[3]].ms) * pow(-1.0,(double)signe));
...
for(k=0; k<electrons; k++)
 {
  ...
  Crystal_Field( states[i][k].l,states[i][k].ml,states[i][k].ms, states_tmp[j][k].l,states_tmp[j][k].ml, states_tmp[j][k].ms);
...
Crystal_Field(states[i][un_paired[1]].l,states[i][un_paired[1]].ml,states[i][un_paired[1]].ms, states_tmp[j][un_paired[1]].l,states_tmp[j][un_paired[1]].ml, states_tmp[j][un_paired[1]].ms);
...
double sumr=0.0, sumi=0.0;
  ...
  if(la!=lb) {printf("Error in Crystal_Field!\n"); exit(0);}


  if(msa!=msb) {RE_CFP=0.0; IM_CFP=0.0; return;}
...
if(method==0)
 {
for(k=0; k<electrons; k++)
  sum=sum + Spin_Orbit( states[i][k].l,states[i][k].ml,states[i][k].ms, states_tmp[j][k].l,states_tmp[j][k].ml, states_tmp[j][k].ms);
 ...
 return(pow(-1.0,(double)signe) * Spin_Orbit(states[i][un_paired[1]].l,states[i][un_paired[1]].ml,states[i][un_paired[1]].ms, states_tmp[j][un_paired[1]].l,states_tmp[j][un_paired[1]].ml, states_tmp[j][un_paired[1]].ms));
...
offdiag = lx(la, mla, lb, mlb)*sx(msa, msb) - ly(la, mla, lb, mlb)*sy(msa, msb);
...
/* Subroutine  int zhpevd_(char *jobz, char *uplo, integer *n,
        doublecomplex *ap, doublereal *w, doublecomplex *z, integer *ldz,
...
if(!(AP = malloc( size*sizeof(doublecomplex))))    
 {printf("No mem_ap!"); free(AP); return(-1);}

if(!(z = malloc( ldz*n*sizeof(doublecomplex))))    
 {printf("No mem_z!"); free(AP); free(z); return(-1);}

if(!(work = malloc(lwork*sizeof(doublecomplex)))) 
 {printf("No mem_work!"); free(AP); free(z); free(work); return(-1);}

if(!(w = malloc(n*sizeof(doublereal))))           
 {printf("No mem_w!"); free(AP); free(z); free(work); free(w); return(-1);}

if(!(rwork = malloc(lrwork*sizeof(doublereal)))) 
 {printf("No mem_rwork!"); free(AP); free(z); free(work); free(w); free(rwork); return(-1);}

if(!(iwork = malloc(liwork*sizeof(integer)))) 
 {printf("No mem_iwork!"); free(AP); free(z); free(work); free(w); free(rwork); free(iwork); return(-1);}


if((pek=gzopen("matrix.gz","rb"))==NULL) {puts("Error in matrix.gz!"); exit(0);}

if((pek3=gzopen("eigenfunctions.gz","wb"))==NULL) {puts("Error in eigenfunctions.gz!"); exit(0);}

if((pek2=fopen("energies","w"))==NULL) {puts("Error in energies!"); exit(0);}
...
if(info!=0) { printf("problems with diagonalize! info = %ld\n",info); exit(0);}
...
if(!(AP = malloc( size*sizeof(doublecomplex))))    {printf("No mem_ap!"); exit(0);}

if(!(z = malloc( ldz*n*sizeof(doublecomplex))))    {printf("No mem_z!"); exit(0);}

if(!(work = malloc(lwork*sizeof(doublecomplex)))) {printf("No mem_work!"); exit(0);}
if(!(w = malloc(n*sizeof(doublereal))))           {printf("No mem_w!"); exit(0);}
if(!(rwork = malloc((3*n-2)*sizeof(doublereal)))) {printf("No mem_rwork!"); exit(0);}
...
if((pek=fopen("pauli.inp","r"))==NULL) {puts("Error in pauli.inp!"); exit(0);}
...
for(i=0; i<STATES; i++)
 { 
  for(j=0; j<electrons; j++)
   ...
   fscanf(pek,"%lf%lf%lf",&states[i][j].l,&states[i][j].ml,&states[i][j].ms);
...
if(method==0)
 {
  for(k=0; k<electrons-1; k++)
   ...
   for(l=k+1; l<electrons; l++)
    {
     sum=sum + General(states[i][l].l, states[i][l].ml,states[i][l].ms, states[i][k].l, states[i][k].ml,states[i][k].ms,states[i][l].l, states[i][l].ml,states[i][l].ms,states[i][k].l, states[i][k].ml,states[i][k].ms) 
                 - 

General(states[i][l].l, states[i][l].ml,states[i][l].ms, states[i][k].l, states[i][k].ml,states[i][k].ms,states[i][k].l, states[i][k].ml,states[i][k].ms,states[i][l].l, states[i][l].ml,states[i][l].ms);
...
for(k=0; k<electrons; k++)
 sum=sum + General(states[i][k].l, states[i][k].ml,states[i][k].ms, states[i][un_paired[1]].l, states[i][un_paired[1]].ml,states[i][un_paired[1]].ms,states[i][k].l, states[i][k].ml,states[i][k].ms,states_tmp[j][un_paired[1]].l, states_tmp[j][un_paired[1]].ml,states_tmp[j][un_paired[1]].ms)                  

            - 

 General(states[i][k].l, states[i][k].ml,states[i][k].ms, states[i][un_paired[1]].l, states[i][un_paired[1]].ml,states[i][un_paired[1]].ms,states_tmp[j][un_paired[1]].l, states_tmp[j][un_paired[1]].ml,states_tmp[j][un_paired[1]].ms,states[i][k].l, states[i][k].ml,states[i][k].ms);
...
return((General(states[i][un_paired[1]].l, states[i][un_paired[1]].ml,states[i][un_paired[1]].ms, states[i][un_paired[2]].l, states[i][un_paired[2]].ml,states[i][un_paired[2]].ms,states_tmp[j][un_paired[1]].l, states_tmp[j][un_paired[1]].ml,states_tmp[j][un_paired[1]].ms,states_tmp[j][un_paired[2]].l, states_tmp[j][un_paired[2]].ml,states_tmp[j][un_paired[2]].ms)
            - 
...
for(k=2; k<=(int)(la+lc); k=k+2)
  sum=sum+ck((double)k,la,mla,lc,mlc)*ck((double)k,ld,mld,lb,mlb)*Rk((double)k);
...
return(pow(-1,mla)*sqrt((2*la+1)*(2*lb+1))*trej1*trej2);
